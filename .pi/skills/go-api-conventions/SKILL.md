---
name: go-api-conventions
description: Reference guide for building Go fasthttp API endpoints. Covers handler patterns, request parsing, response writing, error handling, routing, middleware, testing conventions, and a complete checklist for new endpoints.
