...
class TestUsePolygon:
    ...
    async def test_use_polygon_success(self):
        ...
        with (
            patch("collect.Config") as mock_config_class,
            ...
            mock_polygon.build_bars.assert_called_once_with(
                mock_json_response, "BTC", TimeFrame.day
            )
    ...
    async def test_use_polygon_eth_minute_data(self):
        ...
        with (
            ...
            mock_polygon.build_bars.assert_called_once_with(
                mock_json_response, "ETH", TimeFrame.min
            )
    ...
    async def test_use_polygon_api_error(self):
        ...
        with (
            ...
            mock_polygon = Mock()
            mock_polygon.ohlvc_url = AsyncMock(
                side_effect=ValueError("API Error: Invalid API key")
            )
            mock_polygon.parse_polygon_url.return_value = {
                "symbol": "BTC",
                "mult": "1",
    ...
    async def test_use_polygon_all_timeframes(self):
        ...
        for span_str, expected_timeframe in timeframes:
            url = f"https://api.polygon.io/v2/aggs/ticker/X:BTCUSD/range/1/{
                span_str}/2025-01-01/2025-01-31"
            ...
            with (
                ...
                mock_polygon.build_bars.assert_called_with(
                    mock_json_response, "BTC", expected_timeframe
                )
